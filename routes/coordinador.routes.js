...
router.get('/alumnos/editar-resultado/:id', agregarCicloInfo, coordinador_controller.get_alumno_editar_resultado);
router.post('/alumnos/editar-resultado/eliminar-resultado-inscripcion', coordinador_controller.post_eliminar_materia_del_resultado_inscripcion);
router.post('/alumnos/editar-resultado/agregar-resultado-inscripcion', coordinador_controller.post_agregar_materia_del_resultado_inscripcion);
