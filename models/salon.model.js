...
module.exports = class Salon {
    ...
    save() {
        return pool.query('INSERT INTO salon(salon_id, capacidad, tipo, nota, campus) VALUES ($1, $2, $3, $4, $5)', [this.numero, this.capacidad, this.tipo, this.nota, this.campus]);
    }
